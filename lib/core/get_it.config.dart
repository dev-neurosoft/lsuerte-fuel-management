...
import 'package:fuel_management/core/get_it.dart' as _i8;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.lazySingleton<_i6.VehicleController>(
        () => _i6.VehicleController(gh<_i4.PostgrestClient>()));
    gh.singleton<_i7.AuthController>(
        _i7.AuthController(gh<_i4.PostgrestClient>()));
    return this;
  }
}
